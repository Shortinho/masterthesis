...
# ---- Sync all datasets for 200µm top 35 ------------------------------------
...
# extract Cr inc and Cr coh 200µm

inc.coh <- df.raw$raw.200 %>%
  select('position (mm)', 'Cr inc', 'Cr coh')
names <- names(inc.coh)
tidy.names <- names %>% make.names(unique = T)
names(inc.coh) <- tidy.names
...
#### grayscale dataset on 50 bandwidth ####
path_gs <- '/Users/maxshore/Documents/Unibe/MasterThesis/masterthesis/R/data/generated/grayscale/gray_profile_bw50groups_2filter_0.2mm.csv'
...
# save combined df
write.csv(combined_df, file = 'data/generated/combined/combined_200_inc_coh.csv')
...
write.csv(test.df, file = "data/generated/tables/facies_test_top_200.csv", row.names = FALSE)
write.csv(summary_by_facies, file = "data/generated/tables/facies_basic_stats_top_200.csv", row.names = FALSE)
write.csv(summary_all, file = "data/generated/tables/basic_stats_top_200.csv", row.names = FALSE)
...
# Output folder
output_dir <- "plots/facies_comparison_top_200"
dir.create(output_dir, showWarnings = FALSE, recursive = TRUE)
...
# ---- Sync all datasets for 200µm for all core (AC) ------------------------------------
...
#### grayscale dataset on 50 bandwidth ####
path_gs <- '/Users/maxshore/Documents/Unibe/MasterThesis/masterthesis/R/data/generated/grayscale/gray_profile_ALL_bw50groups_2filter_0.2mm.csv'
...
# save combined df
write.csv(combined_df, file = 'data/generated/combined/combined_AC_200_inc_coh.csv')
...
write.csv(test.df, file = "data/generated/tables/facies_test_AC_200.csv", row.names = FALSE)
write.csv(summary_by_facies, file = "data/generated/tables/facies_basic_stats_AC_200.csv", row.names = FALSE)
write.csv(summary_all, file = "data/generated/tables/basic_stats_AC_200.csv", row.names = FALSE)
...
# Output folder
output_dir <- "plots/facies_comparison_AC_200"
dir.create(output_dir, showWarnings = FALSE, recursive = TRUE)
...
# ---- Sync all datasets for 500µm for all core (AC) ------------------------------------
...
# save combined df
write.csv(combined_df, file = 'data/generated/combined/combined_AC_500_inc_coh.csv')
...
write.csv(test.df, file = "data/generated/tables/facies_test_AC_500.csv", row.names = FALSE)
write.csv(summary_by_facies, file = "data/generated/tables/facies_basic_stats_AC_500.csv", row.names = FALSE)
write.csv(summary_all, file = "data/generated/tables/basic_stats_AC_500.csv", row.names = FALSE)
...
# Output folder
output_dir <- "plots/facies_comparison_AC_500"
dir.create(output_dir, showWarnings = FALSE, recursive = TRUE)
